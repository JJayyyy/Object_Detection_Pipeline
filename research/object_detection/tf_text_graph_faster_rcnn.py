# usage: python tf_text_graph_faster_rcnn.py --input inference_graph/frozen_inference_graph.pb --config training_data/faster_rcnn_inception_v2_pets.config --output training_data/graph.pbtxt
import argparse
import numpy as np
